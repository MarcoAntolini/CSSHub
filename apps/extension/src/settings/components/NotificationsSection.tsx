...
const isPageFeedbackPlacement = (
	value: string
): value is PageFeedbackPlacement =>
...
export const NotificationsSection = ({
	...
	<>
		...
		<div className="toggle-row">
			<div className="toggle-copy">
				...
				<p className="toggle-caption">
					Show system notifications when CssHub syncs, skips, or errors. Click
					on the notification to open the commit or these settings.
				</p>
			</div>
		...
		<div className="page-feedback-field">
			...
			<p className="hint">
				Bottom right automatically moves above CSSBattle&apos;s own feedback
